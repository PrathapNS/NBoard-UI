...
...data[index]
  ...
  const handleSave=async()=>{
    ...
    // setRowIndex(null);
    if(rowIndex!==null){
      await axios.put('http://localhost:8080/user/update/${editedData.userId}',editedData);
      ...
      <Card style={{ width: "80%", marginLeft: "18%", height: "100%", marginTop: "20px",marginBottom:"20px" }}>
        <CardContent>
          <TableContainer  >
           ...
           <h1  >{<PersonIcon />} 
            Users</h1>
            <button style={{backgroundColor:"navy",width:"10%",color:"white"}} onClick={handleAdd}>Add user</button>
           </div>
              ...
              <TableHead >
                <TableRow  >
                  ...
                  <TableCell style={{ fontWeight: "bold", textTransform: "uppercase" }}>Team</TableCell>
                  <TableCell></TableCell>
                </TableRow>
              </TableHead>
              <TableBody >
              {editable&&rowIndex===null&&(
                    <TableRow>
                      ...
                      <TableCell>
                        <TextField value={editedData.team}
              ...
              {data.map((item, index) => (
                  ...
                  <TableRow key={item.id}>
                    ...
                    <TableCell>
                      {editable && rowIndex === index ? <TextField 
